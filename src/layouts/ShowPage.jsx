...
import AnimatedBg from "../utils/AnimatedBg";
  ...
  return (
    <main className="min-h-screen  p-10">
      <div className="max-w-[40%]">
        ...
        >
          <div class="absolute rounded-l-lg inset-0 w-3 bg-orange3 transition-all duration-[550ms] ease-out group-hover:w-full"></div>
          <span class="relative text-gray-700 group-hover:text-white text-2xl">
            Register
          </span>
        </Link>
